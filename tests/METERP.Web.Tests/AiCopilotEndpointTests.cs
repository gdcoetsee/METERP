...
public class AiCopilotEndpointTests : IClassFixture<MeterpWebApplicationFactory>
{
    private readonly MeterpWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public AiCopilotEndpointTests(MeterpWebApplicationFactory factory)
    {
        _factory = factory;
    ...
    [Fact]
    public async Task AiCopilot_RedirectsToLogin_WhenUnauthenticated()
    {
    ...
    [Fact]
    public async Task AiCopilot_ReturnsOk_WhenAuthenticated()
    {
        const string email = "aicopilot@acme.demo";
        await EnsureAiCopilotUserAsync(email);
