...
public class ApprovalsEndpointTests : IClassFixture<MeterpWebApplicationFactory>
{
    private readonly MeterpWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public ApprovalsEndpointTests(MeterpWebApplicationFactory factory)
    {
        _factory = factory;
    ...
    [Fact]
    public async Task Approvals_RedirectsToLogin_WhenUnauthenticated()
    {
    ...
    [Fact]
    public async Task Approvals_ReturnsOk_WhenAuthenticated()
    {
        const string email = "approvals@acme.demo";
        await EnsureApprovalsUserAsync(email);
        ...
        Assert.Contains("approvals-ready", body, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("approvals-tabs", body, StringComparison.OrdinalIgnoreCase);
    }
