...
**2026-08-22:** Integrity stream is **done enough**. Home now converts won work, queues approvals/POs/cash, **chases overdue invoices**, and **records remaining payment in one click**. Payment recording emails the customer a receipt when SMTP is set. Application.Tests **1343** green.
