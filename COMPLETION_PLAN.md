...
**2026-08-15:** Integrity stream is **done enough**. Speed-to-cash and operator-error loops now include Home cash + overdue POs, quote/deposit/unbilled/field/PO scans, and notify chains for quotes, invoices, jobs, requisitions, and leave. Application.Tests **1339** green.
