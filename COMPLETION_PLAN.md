...
**2026-08-22:** Integrity stream is **done enough**. Home now converts won work, queues approvals/POs/cash, **chases overdue invoices**, **records remaining payment**, and **sends draft POs** in one click. Payment recording emails the customer a receipt when SMTP is set. Application.Tests **1344** green.
