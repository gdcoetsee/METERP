...
**2026-08-14:** Integrity stream is **done enough**. Speed-to-cash loop now includes chase, notification click-through, ready-to-invoice + deposit-due queues on Home, send/confirm requires customer email, approval SLA alerts, sign-off notifies finance, unpaid deposit banner, and **creating a job notifies to raise the deposit**. Application.Tests **1298** green.
