...
**2026-08-14:** Integrity stream is **done enough**. Soft-delete on the spine, scheduling double-book/leave clash, outstanding-PPE deactivate/delete, unbilled close acknowledgement, open-REQ close acknowledgement, overdue invoice collections alerts, and extra actual travel on job invoices are in. Application.Tests **1281** green.
