...
**2026-08-14:** Integrity stream is **done enough**. Speed-to-cash loop now includes chase, Home cash queues (invoice, deposit, convert won quotes/SOs), send/confirm requires customer email, **invoice send emails the customer**, SLA alerts, and create/sign-off notifications. Application.Tests **1301** green.
