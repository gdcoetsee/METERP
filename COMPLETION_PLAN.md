...
**2026-08-14:** Integrity stream is **done enough**. Speed-to-cash now includes Home cash queues (deposit only if not yet raised), customer emails, SLA/expiry/overdue-PO/stuck-unbilled/**stuck-deposit**/quote-follow-up scans, and notify-on-transition through credit notes. Application.Tests **1332** green.
