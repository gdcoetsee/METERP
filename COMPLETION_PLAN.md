...
**2026-08-14:** Integrity stream is **done enough**. Soft-delete on the spine, scheduling double-book/leave clash, outstanding-PPE deactivate/delete, unbilled/open-REQ close acknowledgement, overdue collections alerts, extra actual travel on invoices, and **one-click overdue chase** (email + audit) are in. Application.Tests **1284** green.
