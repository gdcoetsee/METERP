...
**2026-08-14:** Integrity stream is **done enough**. Speed-to-cash now includes Home cash queues, customer emails, SLA/expiry/overdue-PO/stuck-unbilled scans, PO send defaults expected date, credit-note notify, and job cancel/reopen/stock-issue notifies. Application.Tests **1329** green.
