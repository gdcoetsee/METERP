...
**Unit tests:** **814 green** (Application.Tests). `main` pushed continuously.

**Tests verified (2026-07-24 continuous):** Document integrity, master-data guards, approvals reject reasons, scheduling/recurring UI, stock-take variance summary, RFQ/job/PO update locks, contact primary promote, employee deactivate on open jobs, field home stats, dismiss-all notifications, audit action filter, quote withdraw from approval.
