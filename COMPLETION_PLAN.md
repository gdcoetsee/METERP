...
**2026-08-14:** Integrity stream is **done enough**. Speed-to-cash now includes Home cash queues, customer emails, SLA/expiry/overdue-PO/**stuck unbilled** scans, and notify-on-transition through invoice cancel, job cancel/reopen, and stock issue. Application.Tests **1327** green.
