...
public static class QuoteUiHelper
{
    ...
    public static Quote? DetachForUi(Quote? source)
    {
        ...
        return new Quote
        {
            ...
            SubmittedForApprovalByUserId = source.SubmittedForApprovalByUserId,
            SubmittedForApprovalAt = source.SubmittedForApprovalAt,
            ExecutiveApprovedByUserId = source.ExecutiveApprovedByUserId,
            ExecutiveApprovedAt = source.ExecutiveApprovedAt,
            ExecutiveRejectionReason = source.ExecutiveRejectionReason,
            ExecutiveDecisionNote = source.ExecutiveDecisionNote,
            Notes = source.Notes,
