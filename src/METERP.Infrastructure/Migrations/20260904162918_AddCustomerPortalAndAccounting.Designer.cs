...
namespace METERP.Infrastructure.Migrations
{
    ...
    [Migration("20260904162918_AddCustomerPortalAndAccounting")]
    partial class AddCustomerPortalAndAccounting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("METERP.Domain.Employee", b =>
                {
                    ...
                    b.Property<decimal>("MandatoryHoursPerMonth")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("METERP.Domain.Job", b =>
                {
                    ...
                    b.Property<Guid?>("ManagerSignedOffByUserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("METERP.Domain.ProcurementSupplierQuote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProcurementSupplierQuotes");
                });

            modelBuilder.Entity("METERP.Domain.ProcurementSupplierQuoteLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ProcurementSupplierQuoteId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("StockRequisitionLineId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProcurementSupplierQuoteId");

                    b.HasIndex("StockRequisitionLineId");

                    b.ToTable("ProcurementSupplierQuoteLines");
                });
            ...
            modelBuilder.Entity("METERP.Domain.Tenant", b =>
                {
                    ...
                    b.Property<string>("AccountingSalesAccountCode")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("METERP.Domain.ProcurementSupplierQuoteLine", b =>
                {
                    b.HasOne("METERP.Domain.ProcurementSupplierQuote", "Quote")
                        .WithMany("Lines")
                        .HasForeignKey("ProcurementSupplierQuoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("METERP.Domain.StockRequisitionLine", "StockRequisitionLine")
                        .WithMany()
                        .HasForeignKey("StockRequisitionLineId");

                    b.Navigation("Quote");

                    b.Navigation("StockRequisitionLine");
                });
