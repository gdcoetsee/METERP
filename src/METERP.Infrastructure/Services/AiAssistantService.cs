...
public class AiAssistantService : IAiAssistantService
{
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            var reasoning = suggestionDoc.RootElement.TryGetProperty("reasoning", out var r) ? r.GetString() ?? "" : "";
            var lines = new List<AiSuggestedLine>();

            if (suggestionDoc.RootElement.TryGetProperty("suggestedLines", out var arr) && arr.ValueKind == JsonValueKind.Array)
            {
